...
st.set_page_config(
    page_title="11795 - Unsupervised Learning",
    page_icon="",
    layout="wide",
...
if uploaded_file is not None:
    ...
    st.markdown("<h1 style='text-align: center;'>Unsupervised Learning - Vivi</h1>", unsafe_allow_html=True)
    st.dataframe(input_data)

    model_directory = r'C:\Users\ASUS\Documents\Tugas4_A_11795'
    model_path = {
